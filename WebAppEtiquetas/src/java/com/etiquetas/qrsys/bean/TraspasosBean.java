...
public class TraspasosBean implements Serializable {
    ...
    public void buscarTraspasosEntrada() {
        ...
        try {
            ...
            listaFacturasV = fDao.listaTraspasoEntrada(fecIni, fecFin, departamento);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public void buscarTraspasosSalida() {
        ...
        try {
            ...
            String fecIni = formato.format(f1);
            String fecFin = formato.format(f2);
            listaFacturasV = fDao.listaTraspasoSalida(fecIni, fecFin, departamento);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public void imprimirQR() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        String ruta = servletContext.getRealPath("/Report/QRTraspasoEntrada.jasper");
    ...
    public void imprimirQRSalida() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        //this.pathReporte="/Report/QRreport.jasper";
        QrPreview reporte = new QrPreview();
        FacesContext facesContext = FacesContext.getCurrentInstance();
        ServletContext servletContext = (ServletContext) facesContext.getExternalContext().getContext();
        String ruta = servletContext.getRealPath("/Report/QRTraspasoSalida.jasper");
        reporte.getReporte(ruta, 1);
        FacesContext.getCurrentInstance().responseComplete();
        regresarEstadoSalidaFalse();
    }
